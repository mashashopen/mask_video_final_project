...
def main():
    ...
    for file in csv_files:
        ...
        face_data.loc[:, 'x1'] = face_data['x1'] / frame_width
        face_data.loc[:, 'y1'] = face_data['y1'] / frame_height
        face_data.loc[:, 'x2'] = face_data['x2'] / frame_width
        face_data.loc[:, 'y2'] = face_data['y2'] / frame_height
